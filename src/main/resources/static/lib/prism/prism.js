...
Prism.languages.racket = Prism.languages.extend("scheme", {}), Prism.languages.DFS(Prism.languages.racket, function (e, r) {
    if ("RegExp" === Prism.util.type(r)) {
        var a = r.source.replace(/\\(.)|\[\^?((?:\\.|[^\\\]])*)\]/g, function (e, r, a) {
            if (r) {
                if ("(" === r) return "[([]";
                if (")" === r) return "[)\\]]"
            }
            return a ? ("^" === e[1] ? "[^" : "[") + a.replace(/\\(.)|[()]/g, function (e, r) {
                return "(" === e || "(" === r ? "([" : ")" === e || ")" === r ? ")\\]" : e
            }) + "]" : e
        });
        this[e] = RegExp(a, r.flags)
    }
